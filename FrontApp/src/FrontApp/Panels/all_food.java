...
public class all_food extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/front/food.png"))); // NOI18N
        add(jLabel1);
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        try {
             staticV.cat = " category = 'Sandwiches'";
            card_panal.add("data", new data());
            Project.card.show(card_panal, "data");
        } catch (Exception ex) {
        }
