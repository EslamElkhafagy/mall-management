...
public class all_electronic extends javax.swing.JPanel {
    data d ;
    public all_electronic() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/front/all_electronic.png"))); // NOI18N
        add(jLabel1);
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        try {
            staticV.cat = " category = 'camera' OR category = 'console'";
            card_panal.add("data", new data());
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        try {
            staticV.cat = " category = 'mobile' OR category = 'tablet'";
            card_panal.add("data", new data());
            Project.card.show(card_panal, "data");
        } catch (Exception ex) {
        }
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        try {
            staticV.cat = " category = 'labtob' OR category = 'pc'";
            card_panal.add("data", new data());
            Project.card.show(card_panal, "data");
        } catch (Exception ex) {}
